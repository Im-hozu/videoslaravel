        ...
        <div class="comment-item col-md-12 pull-left">
            <div class="panel panel-default comment-data">
                <div class="panel-heading">
                    ...
                    <strong><a href="">{{$comment->user->name.' '.$comment->user->surname.'  '}}</a></strong>{{\FormatTime::LongTimeFilter($comment->created_at)}}
                    </div>
                </div>
                ...
                <a href="#Pop{{$comment->id}}" role="button" class="btn btn-sm btn-primary" data-toggle="modal">Borrar</a>
                
                <!-- Modal / Ventana / Overlay en HTML -->
                <div id="Pop{{$comment->id}}" class="modal fade">
